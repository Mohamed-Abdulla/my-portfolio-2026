...
import { Server, ShieldAlert, Database, Cpu } from "lucide-react";
...
const SkillsGlobe = dynamic(() => import("../three/SkillsGlobe"), {
  ssr: false,
  loading: () => (
    <div className="h-80 sm:h-100 w-full flex items-center justify-center">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 flex flex-col items-center">
            ...
            {/* Category Legend */}
            <div className="mt-8 flex flex-wrap justify-center gap-4 max-w-sm">
              <div className="flex items-center gap-1.5 text-[11px] text-slate-400">
                <span className="w-2.5 h-2.5 rounded-full bg-[#3b82f6] block" />
                Frontend / JS
              </div>
              <div className="flex items-center gap-1.5 text-[11px] text-slate-400">
                <span className="w-2.5 h-2.5 rounded-full bg-[#a78bfa] block" />
                Backend APIs
              </div>
              <div className="flex items-center gap-1.5 text-[11px] text-slate-400">
