                ...
                <div className="w-full max-w-sm bg-slate-950/80 rounded-2xl border border-card-border/80 overflow-hidden font-mono text-[10px] sm:text-xs text-left shadow-lg">
                  ...
                  <div className="p-4 space-y-3">
                    <div className="flex flex-wrap items-center gap-1">
                      ...
                      <span className="text-slate-300 truncate">https://api.colakin.com/v1/auth/verify</span>
                    </div>
          ...
          <BentoGridItem
            ...
            header={
              <div className="flex justify-end w-full mb-4">
                ...
                <div className="w-full max-w-[220px] bg-slate-950/80 rounded-3xl border-2 border-slate-800 overflow-hidden font-sans text-left relative shadow-xl mx-auto sm:mx-0 shrink-0">
